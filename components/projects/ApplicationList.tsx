                    ...
                    <div className=" border border-transparent hover:border-blue-100 shadow-lg rounded-2xl bg-white w-full">
                        ...
                        <div className="w-full flex flex-col my-2">
                            ...
                            <div className="px-4 w-full flex justify-center my-2" onClick={(e) => {
                                ...
                                <p className="bg-transparent border border-ramppblue text-ramppblue hover:bg-ramppblue hover:text-white text-base px-6 py-1 rounded-md cursor-hover">Manage Plugin</p>
                            </div>
                        </div>
                    </div>
                </div>
